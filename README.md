...
9. **Data quality issues:** If data is missing or unreliable, KCOR might give misleading results. For example, the Czech data is missing birthdates for over 1M unvaccinated people. This could affect age comparisons. However, this does not invalidated vaccinated to vaccinated comparisons, e.g., Dose 3 group vs. Dose 2 group because those people had to present while alive so data capture is more reliable.
