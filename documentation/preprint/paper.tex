...
§2.7.1. Pooling in this procedure occurs only across prespecified quiet
windows within the same cohort; there is no shared \(\theta_0\)
parameter across cohorts.
...
periods before the final frailty refit.
