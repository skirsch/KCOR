...
% Appendix lettered numbering for figures and equations (Pandoc maps ## headers to \subsection).
\usepackage{chngcntr}
\usepackage{etoolbox}
\pretocmd{\appendix}{%
...
% Pandoc maps ### headers to \subsubsection in LaTeX, so use subsubsection as the
% appendix-letter driver for table numbering here.
\setcounter{subsubsection}{0}%
\renewcommand{\thesubsubsection}{\Alph{subsubsection}}%
\counterwithin{table}{subsubsection}%
\renewcommand{\thetable}{\thesubsubsection.\arabic{table}}%

\subsubsection{Appendix A tables}\label{appendix-a-tables}

\subsubsection{Appendix B tables}\label{appendix-b-tables}
