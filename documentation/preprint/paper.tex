...
\item
  ...
  observed cumulative hazards. Empirical robustness of the fitted
  frailty parameters to quiet-window placement (12-month windows shifted
  monthly) is demonstrated in Supplementary Figure
...
reflecting near-linear cumulative hazards and weak or absent depletion
curvature rather than estimator instability. Open markers denote windows
failing diagnostics (treated as non-identified and not interpreted).
