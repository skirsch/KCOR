...
@fig kcor_v6_schematic: Three-panel schematic illustrating (i) individual hazards under multiplicative frailty, (ii) selection-induced depletion curvature in observed cumulative hazards, and (iii) alignment of baseline cumulative hazards after gamma-frailty inversion. (Source: `documentation/preprint/figs/kcor_v6_schematic.png`)
